...
#define LCEC_ROVIX_VID 0x00000227
...
#define LCEC_MAX_PDO_REG_COUNT   256  ///< The maximum number of calls to lcec_pdo_init() for a single driver.
...
lcec_modparam_desc_t *lcec_modparam_desc_override(lcec_modparam_desc_t const *a, lcec_modparam_desc_t const *b);
